...
- [client_postgres.go](../../go/core/internal/database/client_postgres.go) - Database helpers with atomic upserts
- [client.go](../../go/api/database/client.go) - Database client interface
